...
namespace CogServicesVisionSamples_202107.Pages
{
    public class FaceModel : PageModel
    {
        ...
        private const string faceEndpoint = "YOUR_SUBSCRIPTION_ENDPOINT"; //"https://YOUR_SERVICE_NAME.cognitiveservices.azure.com/"
